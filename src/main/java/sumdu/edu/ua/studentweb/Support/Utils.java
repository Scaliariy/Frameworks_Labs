...
public class Utils {
    ...
    public static String calculatePopularDomain(List<Student> studs) throws EmailException {
    ...
    public static double calculateMeanAge(List<Student> studs) {
        double tempAge = 0;
        int count = 0;
        for (Student st : studs) {
    ...
    public static double calculateYoungestStudent(List<Student> studs) {
    ...
    public static double calculateOldestStudent(List<Student> studs) {
    ...
    public static double calculateSumduDomain(List<Student> studs) throws EmailException {
        String tempDomain;
        double count = 0;
        for (Student st : studs) {
            if (Utils.patternMatches(st.getEmail())) {
    ...
    public static String calculateDifferentGroups(List<Student> studs) {
    ...
    public static String calculateNumberStudentsFromDifferentFaculties(List<Student> studs) {
